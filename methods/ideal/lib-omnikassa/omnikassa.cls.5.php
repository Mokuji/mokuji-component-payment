<?php
	...
	*/
	...
	class OmniKassa
	{
		...
		/**
		 * Added afterwards because the normal library builds a really ugly form.
		 * @author Beanow <beanow@project-virality.com>
		 * @return array Associative array with the raw data to build a form.
		 */
